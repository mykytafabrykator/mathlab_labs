// -------------------------------------------------------------
// 
// File Name: C:\Users\Mykyta\Documents\MATLAB\lab_2\fixed\CALC_MODEL\CALC_MAGNITUDE_AND_PHASE_FIXED.v
...
// Source Path: CALC_MODEL/CALC_MAGNITUDE_AND_PHASE_FIXED
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module CALC_MAGNITUDE_AND_PHASE_FIXED
  ...
  input   reset;
  input   clk_enable;
  input   [31:0] i_COMPLEX_VALUE_re;  // ufix32_En18
  input   [31:0] i_COMPLEX_VALUE_im;  // ufix32_En18
  input   i_VALID;
  output  ce_out;
  output  [15:0] o_PHASE;  // ufix16_En13
  output  [32:0] o_MAGNITUDE;  // ufix33_En18
  output  o_VALID;


  wire enb;
  wire signed [31:0] Data_Type_Conversion_out1;  // sfix32_En18
  wire signed [31:0] Data_Type_Conversion1_out1;  // sfix32_En18
  wire signed [31:0] Atan2_out1;  // sfix32_En29
  wire [15:0] Data_Type_Conversion2_out1;  // ufix16_En13
  reg [15:0] delayMatch_reg [0:11];  // ufix16 [12]
  wire [15:0] delayMatch_reg_next [0:11];  // ufix16_En13 [12]
  wire [15:0] Data_Type_Conversion2_out1_1;  // ufix16_En13
  wire [63:0] Product_out1;  // ufix64_En36
  wire [63:0] Product1_out1;  // ufix64_En36
  wire [64:0] Add_add_cast;  // ufix65_En36
  wire [64:0] Add_add_cast_1;  // ufix65_En36
  wire [64:0] Add_out1;  // ufix65_En36
  wire [32:0] Sqrt_out1;  // ufix33_En18
  reg  [0:34] delayMatch1_reg;  // ufix1 [35]
  wire [0:34] delayMatch1_reg_next;  // ufix1 [35]
  wire i_VALID_1;


  assign Data_Type_Conversion_out1 = i_COMPLEX_VALUE_im;



  assign Data_Type_Conversion1_out1 = i_COMPLEX_VALUE_re;
  ...
  atan2_cordic_nw u_Atan2_inst (.clk(clk),
                                .reset(reset),
                                .enb(clk_enable),
                                .y_in(Data_Type_Conversion_out1),  // sfix32_En18
                                .x_in(Data_Type_Conversion1_out1),  // sfix32_En18
  ...
  assign Data_Type_Conversion2_out1_1 = delayMatch_reg[11];
  assign delayMatch_reg_next[0] = Data_Type_Conversion2_out1;
  ...
  assign o_PHASE = Data_Type_Conversion2_out1_1;
  ...
  assign Add_add_cast = {1'b0, Product_out1};
  assign Add_add_cast_1 = {1'b0, Product1_out1};
  ...
  Sqrt u_Sqrt (.clk(clk),
               .reset(reset),
               .enb(clk_enable),
               .din(Add_out1),  // ufix65_En36
               .dout(Sqrt_out1)  // ufix33_En18
               );
  ...
  assign i_VALID_1 = delayMatch1_reg[34];
